...
\documentclass[type=master,review,openany,onside]{sjtuthesis}
% 选项
...
%\input{contents/method_quant}
%\input{contents/methdology1}
%\input{contents/methdology2}
%\input{contents/methdology3}
